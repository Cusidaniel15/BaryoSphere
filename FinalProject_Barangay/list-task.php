...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.6.0/css/all.min.css" integrity="sha512-Kc323vGBEqzTmouAECnVceyQqyqdsSiqLQISBL29aUW4U/M7pSPA/gEUZQqv1cwx4OnYxTxve5UMg5GT6L4JJg==" crossorigin="anonymous" referrerpolicy="no-referrer" />
    ...
    <header>
        ...
        <!-- Menu Starts Here -->
    <nav>
        <h2 style="background: #8eb69b; text-align:center; border-radius:10px; padding:10px;justify-content:center; color:white; margin-bottom:20px;">Project Manager</h2>
    ...
    <!-- Menu Ends Here -->
        ...
        <div class="all-task">
            ...
            <a href="<?php echo SITEURL; ?>add-task.php"><button class="btn btn-dark" style="margin-top:5px; background: #64db7c; border:1px solid white;">Add Project</button></a>
